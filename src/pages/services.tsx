...
export default function ServicesPage() {
    ...
    return (
        <>
            <SEO title="Services - Salestaxus LLC" description="Complete US business formation and tax compliance services." />
            <div className="min-h-screen bg-slate-50">
                ...
                <div className="max-w-7xl mx-auto px-4 py-16">
                    <div className="text-center mb-16">
                        ...
                        <p className="text-xl text-slate-600 max-w-2xl mx-auto">Everything you need to form, comply, and scale your US business.</p>
                    </div>
                    ...
                    <div className="mt-16 bg-white p-8 rounded-2xl shadow-sm border border-slate-100">
                        <div className="grid md:grid-cols-2 gap-8 items-center">
                            <div>
                                ...
                                <p className="text-slate-600 mb-6">Every business is unique. If you don't see exactly what you need, contact us for a custom quote.</p>
                                <Link href="/checkout">
                                    <Button variant="outline" className="border-blue-600 text-blue-600 hover:bg-blue-50">Contact Support</Button>
                                </Link>
                            </div>
                            <div className="bg-blue-50 p-6 rounded-xl">
                                <h4 className="font-bold text-slate-900 mb-4">Why Choose Us?</h4>
                                <ul className="space-y-3">
                                    <li className="flex items-center gap-2 text-slate-700"><CheckCircle2 className="w-5 h-5 text-blue-600" /> 500+ International Clients</li>
                                    <li className="flex items-center gap-2 text-slate-700"><CheckCircle2 className="w-5 h-5 text-blue-600" /> 5.0 Rating on Fiverr</li>
                                    <li className="flex items-center gap-2 text-slate-700"><CheckCircle2 className="w-5 h-5 text-blue-600" /> 100% Legal Method</li>
                                    <li className="flex items-center gap-2 text-slate-700"><CheckCircle2 className="w-5 h-5 text-blue-600" /> Non-US Resident Experts</li>
                                </ul>
                            </div>
                        </div>
                    </div>
