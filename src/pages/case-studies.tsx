...
import { Star, Globe, TrendingUp, Shield, ArrowLeft } from "lucide-react";
      ...
      <div className="min-h-screen bg-slate-50">
        ...
        <div className="max-w-5xl mx-auto px-4 py-16">
          <div className="text-center mb-16">
            <h1 className="text-5xl font-bold text-slate-900 mb-4">Client Success Stories</h1>
            ...
            <Card className="overflow-hidden border-0 shadow-lg">
              ...
              <CardContent className="p-8">
                ...
                <div className="bg-slate-50 p-6 rounded-xl border border-slate-100">
                  ...
                  <p className="font-bold text-slate-900">— MAGISNAT</p>
                </div>
              </CardContent>
            </Card>
            ...
            <Card className="overflow-hidden border-0 shadow-lg">
              ...
              <CardContent className="p-8">
                ...
                <div className="bg-slate-50 p-6 rounded-xl border border-slate-100">
                  ...
                  <p className="text-slate-700 italic mb-4">&quot;We got a $100k tax notice. ecomifyUSA reviewed our documents, switched the calculation method, and reduced it to $450. Incredible savings.&quot;</p>
                  <p className="font-bold text-slate-900">— Accelertrain</p>
                </div>
              </CardContent>
            </Card>
            ...
            <Card className="overflow-hidden border-0 shadow-lg">
              ...
              <CardContent className="p-8">
                <div className="grid md:grid-cols-3 gap-8 mb-8">
                  <div>
                    <h4 className="font-bold text-slate-900 mb-2">Challenge</h4>
                    <p className="text-slate-600 text-sm">Lost access to 9 state portals. Louisiana penalty charged. Could not file.</p>
                  </div>
                  <div>
                    <h4 className="font-bold text-slate-900 mb-2">Solution</h4>
                ...
                <div className="bg-slate-50 p-6 rounded-xl border border-slate-100">
                  ...
                  <p className="text-slate-700 italic mb-4">&quot;My previous freelancer disappeared. ecomifyUSA recovered every single portal and cleaned up my Louisiana penalty. Now I have full control.&quot;</p>
                  <p className="font-bold text-slate-900">— Trade Connect Global LLC</p>
                </div>
              </CardContent>
            </Card>
          </div>
