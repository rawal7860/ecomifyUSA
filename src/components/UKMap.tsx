...
// The stable CDN link you identified
const geoUrl = "https://cdn.jsdelivr.net/npm/uk-atlas@1/uk/nations-10m.json";

// Regional data for Salestaxus LLC services
        ...
        <div className="w-full max-w-4xl mx-auto relative select-none">
            <Card className="border-none shadow-xl bg-white/50 backdrop-blur-sm overflow-hidden">
                <CardContent className="p-0 relative">
                    <ComposableMap
                        // UK Projection centered over the British Isles
                    ...
                    {/* Tooltip implementation matching your USMap style */}
                    <Tooltip
                        id="uk-tooltip"
                        place="right"
                        float
                            ...
                            return (
                                <div className="bg-white rounded-lg shadow-2xl border border-slate-200 p-4 min-w-[280px] text-left animate-in fade-in zoom-in-95 duration-200">
                                    <div className="flex justify-between items-center mb-3 pb-2 border-b border-slate-100">
                                        <h3 className="font-bold text-lg text-slate-900">{info.name || content}</h3>
                                    ...
                                    <div className="space-y-2.5 text-sm">
                                        ...
                                        <div className="flex justify-between items-center italic text-[11px] text-slate-400">
                                            <span>Includes Articles & HMRC Setup</span>
                                        </div>
                                    </div>
